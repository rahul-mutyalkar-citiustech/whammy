...
export let Whammy = (function(){
  ...
  //TODO: the video compile does not work on iOS, based on my research it is because atob is not defined.
  // So technically if we define atob it should work
